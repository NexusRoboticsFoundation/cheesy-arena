...
func (arena *Arena) GenerateMatchLoadMessage() any {
	...
	// Don't allow manual substitution of practice/playoff teams if they are automatically pulled from Nexus.
	var allowManualSubstitution = arena.CurrentMatch.ShouldAllowSubstitution() && !(arena.EventSettings.NexusEnabled && arena.CurrentMatch.ShouldAllowNexusSubstitution())
